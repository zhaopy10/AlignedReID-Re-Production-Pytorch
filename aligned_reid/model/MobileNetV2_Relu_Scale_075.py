...
def MobileNetV2(input_size=224, scale=1.0, pretrained=False):
    ...
    if pretrained:
        ...
        filename = '/home/corp.owlii.com/peiyao.zhao/reid/AlignedReID-Re-Production-Pytorch/aligned_reid/model/model_best_0.75_pyz.pth.tar'
...
class MobileNetV2_base(nn.Module):
    def __init__(self, n_class=1000, input_size=224):
        ...
        self.interverted_residual_setting = [
            ...
            [1, 16, 1],
            [6, 24, 2], [6, 24, 1],
            [6, 24, 2], [6, 24, 1], [6, 24, 1],
            [6, 48, 2], [6, 48, 1], [6, 48, 1], [6, 48, 1],
            [6, 72, 1], [6, 72, 1], [6, 72, 1],
            [6, 120, 2], [6, 120, 1], [6, 120, 1],
            [6, 240, 1],
        ]

        # building first layer
        assert input_size % 32 == 0
        input_channel = int(24)
